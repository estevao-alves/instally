        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Collections_Users_UserEntityId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    WingetId = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Packages_Collections_CollectionEntityId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Collections_UserEntityId",
                table: "Collections",
                column: "UserEntityId");

            migrationBuilder.CreateIndex(
                name: "IX_Packages_CollectionEntityId",
                table: "Packages",

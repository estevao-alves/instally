...
using Instally.Setup.Application.Requirements;
using Instally.Setup.Application.Functions;
using Instally.Setup.Application;
...
namespace Instally.Setup
{
    public partial class MainWindow : Window
    {
        ...
        private async void AbrirApp(object sender, RoutedEventArgs e)
        {
            try
            {
                string result = await Task.Run(() => Command.Executar("cmd.exe", @$"/c; start C:\Saturnia\Instally\Instally.App.exe"));
